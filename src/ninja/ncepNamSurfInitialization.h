/******************************************************************************
 *
 * $Id: ncepNamSurfInitialization.h 
 * Project:  WindNinja
 * Purpose:  NCEP NAM Surface Model Initalization derived class
...
#ifndef NCEP_NAM_SURF_INITIALIZATION_H
 ...
 */
class ncepNamSurfInitialization : public wxModelInitialization
{
 public:

    ncepNamSurfInitialization();
    virtual ~ncepNamSurfInitialization();

    ncepNamSurfInitialization( ncepNamSurfInitialization const& A );
    ncepNamSurfInitialization& operator= ( ncepNamSurfInitialization const& m );
...
#endif //NCEP_NAM_SURF_INITIALIZATION_H
