...
class pointInitialization : public initialize
{
    ...
    private:
        ...
        static double getStationHeight(const char *name_list);
        ...
        static std::vector<double> computeSolarToCloud(const CPLJSONArray& solar_radiation, const std::string& timeZone,
