...
*
*/
ncepDgexSurfInitialization::ncepDgexSurfInitialization() : wxModelInitialization()
{
...
*/
ncepDgexSurfInitialization::ncepDgexSurfInitialization(ncepDgexSurfInitialization const& A ) : wxModelInitialization(A)
{
...
* Destructor.
*/
ncepDgexSurfInitialization::~ncepDgexSurfInitialization()
{
}
...
*/
ncepDgexSurfInitialization& ncepDgexSurfInitialization::operator= (ncepDgexSurfInitialization const& A)
{
    if(&A != this) {
...
*/
double ncepDgexSurfInitialization::getGridResolution()
{
    return -1.0;
}
...
*/
std::vector<std::string> ncepDgexSurfInitialization::getVariableList()
{
...
*/
std::string ncepDgexSurfInitialization::getPath()
{
    return std::string( "/thredds/ncss/grid/grib/NCEP/DGEX/CONUS_12km/best?north=USER_NORTH&west=USER_WEST&east=USER_EAST&south=USER_SOUTH&time_start=present&time_duration=PTUSER_TIMEH&accept=netcdf");
}

int ncepDgexSurfInitialization::getStartHour()
{
    return 84;
}

int ncepDgexSurfInitialization::getEndHour()
{
    return 168;
}
...
*/
void ncepDgexSurfInitialization::checkForValidData()
{
...
/**
* Sets the surface grids based on a ncepDgex (surface only!) forecast.
...
*/
void ncepDgexSurfInitialization::setSurfaceGrids( WindNinjaInputs &input,
        ...
        AsciiGrid<double> &wGrid )
{
    ...
    for( unsigned int i = 0;i < varList.size();i++ ) {
        ...
        if( srcWkt.empty() ) {
            CPLDebug( "ncepDgexInitialization::setSurfaceGrids()",
                    "Bad forecast file" );
            //throw
        }
