...
#ifndef NINJA_MASS_CONSERVING_STEADY_STATE_INCLUDED_
#define NINJA_MASS_CONSERVING_STEADY_STATE_INCLUDED_
 ...
 *
 */
class NinjaMassConservingSteadyState : public ninja
{
public:
    NinjaMassConservingSteadyState();
    virtual ~NinjaMassConservingSteadyState();

    NinjaMassConservingSteadyState( NinjaMassConservingSteadyState const& A );
    NinjaMassConservingSteadyState& operator= ( NinjaMassConservingSteadyState const& A );
