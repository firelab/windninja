    ...
    try {
        ...
        */
        ...
        config.add_options()
                ...
                ("goog_out_use_consistent_color_scheme",po::value<bool>()->default_value(false),"Use a consistent color scale across simulations (true, false)")
...
//STATION_FETCH
            ...
            if(vm["write_goog_output"].as<bool>())
            {
                ...
                windsim.setGoogConsistentColorScheme(i_,vm["goog_out_use_consistent_color_scheme"].as<bool>(),windsim.getSize());
            }
