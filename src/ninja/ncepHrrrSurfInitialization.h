/******************************************************************************
 *
 * $Id: ncepHrrrSurfInitialization.h 
 *
 * Project:  WindNinja
 ...
 * in GRIB2 format.
 */
class ncepHrrrSurfInitialization : public wxModelInitialization
{
 public:

    ncepHrrrSurfInitialization();
    virtual ~ncepHrrrSurfInitialization();

    ncepHrrrSurfInitialization( ncepHrrrSurfInitialization const& A );
    ncepHrrrSurfInitialization& operator= ( ncepHrrrSurfInitialization const& m );
