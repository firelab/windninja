...
void NinjaFoam::writeMassMeshVtkOutput()
{
    ...
    try {
		...
		volVTK VTK(u, v, w, massMesh.XORD, massMesh.YORD, massMesh.ZORD, dem_copy.get_xllCorner(), dem_copy.get_yllCorner(), dem_copy.get_nCols(), dem_copy.get_nRows(), massMesh.nlayers, massMeshVtkFilename, vtkWriteFormat, vtk_out_as_utm);
	} catch (exception& e) {
