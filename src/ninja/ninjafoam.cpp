...
bool NinjaFoam::simulate_wind()
{
    ...
    CPLDebug("NINJAFOAM", "input corrected direction = %lf", wrap0to360( input.inputDirection + input.dem.getAngleFromNorth() )); //account for projection rotation from north
