 ...
 * in GRIB2 format.
 */
class ArchivedHRRRInitialization : public wxModelInitialization
{
 public:

    ArchivedHRRRInitialization();
    virtual ~ArchivedHRRRInitialization();

    ArchivedHRRRInitialization( ArchivedHRRRInitialization const& A );
    ArchivedHRRRInitialization& operator= ( ArchivedHRRRInitialization const& m );
