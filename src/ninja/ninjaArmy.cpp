...
{
    ninjas.push_back(new NinjaMassConservingSteadyState());
    initLocalData();
}
    ...
    if(ninjas.size() == 1)
    {
        ...
        try{
            ...
            if(ninjas[0]->identify() == "ninjafoam" & ninjas[0]->input.diurnalWinds == true){
                ...
                ninja* diurnal_ninja = new NinjaMassConservingSteadyState();
