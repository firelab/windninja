...
#include "verticalProfileTemperatureInletFvPatchScalarField.H"
...
verticalProfileTemperatureInletFvPatchScalarField::verticalProfileTemperatureInletFvPatchScalarField
(
    const fvPatch& p,
...
verticalProfileTemperatureInletFvPatchScalarField::verticalProfileTemperatureInletFvPatchScalarField
(
    const verticalProfileTemperatureInletFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
verticalProfileTemperatureInletFvPatchScalarField::verticalProfileTemperatureInletFvPatchScalarField
(
    const verticalProfileTemperatureInletFvPatchScalarField& fcvpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void verticalProfileTemperatureInletFvPatchScalarField::updateCoeffs()
{
    // Caluculate Input Wind Height
    scalarField tempp(patch().Cf().size(), scalar(0));
    ...
    forAll(tempp, faceI)
    {
        ...
        if(AGL > 200){
            tempp[faceI] = 300 - 0.11*AGL;
        }
        else{
            tempp[faceI] = 278 + 0.11*AGL;
        }
    }
...
// Write
void verticalProfileTemperatureInletFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, verticalProfileTemperatureInletFvPatchScalarField);
