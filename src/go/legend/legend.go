...
var colorSchemes = map[string][5]color.Color{
	"default": [5]color.Color{
...
// DrawLegend
func DrawLegend(w io.Writer, breaks []float64, scheme string, units string) error {
	colors, ok := colorSchemes[scheme]
	if !ok {
