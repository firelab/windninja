...
This document provides guidance on the use of a specific WindNinja CLI (Command Line Interface) configuration file. 
This file is tailored for initializing WindNinja simulations using a domain average initialization method and non-neutral atmospheric stability effects.
...
The following settings are included in the `.cfg` file. A list of required settings for CLI runs can be found in `windninja/doc/CLI_instructions.pdf`.
