...
if __name__ == "__main__":
   ...
   # Use WINDNINJA_DATA environment variable
    ...
    destination_dir = './'
    files_to_copy = ['missoula_valley.tif']
    data_dir2 = data_dir + '/WXSTATIONS-2018-06-25-1237-missoula_valley'
    copy_files(data_dir, destination_dir, files_to_copy)
    files_to_copy = ['missoula_valley_stations_4.csv','KMSO-2018-06-25_1237-0.csv', 'PNTM8-2018-06-25_1237-2.csv', 'TR266-2018-06-25_1237-3.csv', 'TS934-2018-06-25_1237-1.csv']
    copy_files(data_dir2, destination_dir, files_to_copy)
    run_windninja("./cli_pointInitialization_timeseries.cfg")
