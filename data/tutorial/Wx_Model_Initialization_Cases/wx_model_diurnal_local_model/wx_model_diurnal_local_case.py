...
if __name__ == "__main__":
   ...
   # Use WINDNINJA_DATA environment variable
    ...
    destination_dir = './'
    files_to_copy = ['big_butte_small.tif']

    copy_files(data_dir, destination_dir, files_to_copy)

    files_to_copy2 = ['20170603T1800.nc']

    copy_files(data_dir, destination_dir,files_to_copy2)

    run_windninja("./cli_wxModelInitialization_diurnal_local_model.cfg")
