...
<html>
    ...
    <body>
        <p>Click on any image thumbnail to enlarge. Click again to hide:</p><br><p>The Windrose plots compare direction data, Orange bars are simulated winds, blue bars are observed winds</p>
