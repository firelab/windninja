...
<div class="col col-6">
  <div class="block pink">
      <div class="block-body height-1">
          ...
          <h2>
            <a class="post-link white-text" href="/windninja/internal/dust/">Dust Emissions Model</a>
          </h2>
...
<div class="col col-3">
  <div class="block purple">
      <div class="block-body height-1">
          ...
          <h2>
            <a class="post-link white-text" href="https://github.com/firelab/windninja/blob/master/NEWS.md">Change Log</a>
          </h2>
      </div>
  </div>
</div>
